...
#pragma region Methods
  ...
  REACT_METHOD(startLiveness)
  void startLiveness(int viewTag) noexcept {
    auto asyncOp = winrt::ReactNativeCameraCPP::implementation::ReactCameraViewManager::startLiveness(viewTag);
  }

  REACT_METHOD(stopLiveness)
  void stopLiveness(int viewTag) noexcept {
    auto asyncOp = winrt::ReactNativeCameraCPP::implementation::ReactCameraViewManager::stopLiveness(viewTag);
  }
